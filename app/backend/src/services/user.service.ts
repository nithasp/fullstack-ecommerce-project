...
export async function getUserWithPurchases(
  id: number,
): Promise<PublicUser & { recentPurchases: RecentPurchase[] }> {
...
export async function updateProfile(id: number, changes: ProfileUpdate): Promise<PublicUser> {
...
export async function changeRole(actingUserId: number, id: number, role: UserRole): Promise<PublicUser> {
...
export async function closeAccount(id: number): Promise<PublicUser> {
